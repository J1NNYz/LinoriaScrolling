...
local Library = {
    ...
    FontColor = _G.Config["Font"];
    MainColor = _G.Config["MainColor"];
    BackgroundColor = _G.Config["BackgroundColor"];
    AccentColor = _G.Config["AccentColor"];
    OutlineColor = _G.Config["OutlineColor"];
